    ...
    return (
        <div className='bg-[#ffffff]'>
            <footer className='flex flex-col border-t-[6px] border-[#E2E2E2] relative z-10 w-full'>
                ...
                gap-10 md:gap-40 min-h-[220px] w-full max-w-[1200px] px-6 md:px-10 py-10 mx-auto '>
                ...
                <div className='w-full border-t border-[#E2E2E2]'>
                    <div className='w-full max-w-[1200px] mx-auto px-6 md:px-20 py-3'>
                        ...
                        <div className='flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 py-2
                        font-sans text-[12px]'>
