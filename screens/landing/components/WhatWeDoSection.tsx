...
const WhatWeDoSection = () => {
  return (
    <section className="relative w-full px-4 sm:px-6 md:px-10 lg:px-16 2xl:px-24 py-12 md:py-16 lg:py-20 mt-20">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row  items-center gap-12 lg:gap-20 xl:gap-30 bg-[red]">
        {/* Image Section */}
        <div className="relative w-full md:w-[80%] lg:w-1/2 xl:w-[60%] h-[280px] sm:h-[350px] md:h-[450px] lg:h-[420px] xl:h-[480px]">
          <div className="w-full h-full overflow-hidden rounded-2xl">
            <Image
              ...
              className="object-cover 
                ...
                md:rounded-tr-[60px] md:rounded-bl-[60px] md:rounded-br-[120px] md:rounded-tl-[120px] 
          ...
          {/* Success Badge */}
          <div
            className="absolute bg-[#2F5381] text-white shadow-lg flex flex-col justify-center items-center
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-5 md:space-y-6">
          <h1 className="text-[22px] sm:text-[26px] md:text-[30px] font-medium leading-tight text-[#231F20]">
          ...
          <button
            type="button"
            className="mt-4 text-[15px] sm:text-[16px] md:text-[18px] font-medium rounded-full 
            bg-[#ff6a2e] px-8 sm:px-10 py-2.5 sm:py-3 text-white shadow-lg 
            hover:bg-[#ff5a15] transition-colors duration-300
            w-full sm:w-auto max-w-[200px] mx-auto lg:mx-0"
          >
            ปรึกษาฟรี
          </button>
        </div>
