...
const PricePlanSection = () => {
    return (
        <section className='w-full mx-auto mt-50'>
            <div className=' w-full h-[590px] bg-[green]'>
                <div className='flex w-[1000px] mx-auto   bg-[red]'>
                    <div className='flex flex-col pt-5 mr-15 space-y-5 bg-[blue] w-[35%]'>
