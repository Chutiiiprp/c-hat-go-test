...
const ContactFormBlock: React.FC = () => {
  return (
    <div className="w-full h-full  md:px-15 md:py-10 lg:px-0">
      <div className="h-full rounded-xl bg-white px-6 py-7 md:px-8 md:py-8 lg:px-5 lg:py-5 shadow-[0_18px_45px_rgba(15,20,50,0.08)]">
        <h3 className="text-lg text-[24px] font-kanit font-medium mb-6 md:mb-8 text-[#1a1a1a]">
          ส่งเอกสารประเมินฟรี
        </h3>
        ...
        <form className="space-y-5 md:space-y-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <label htmlFor="company" className="text-[16px] text-gray-700">
                ชื่อร้าน/บริษัท
              </label>
              <input
                type="text"
          ...
          <div>
            <label htmlFor="service" className="text-[16px] text-gray-700">
              สนใจบริการ
            </label>
            <select
              id="service"
          ...
          <div>
            <label htmlFor="message" className="text-[16px] text-gray-700">
              รายละเอียดเพิ่มเติม
            </label>
            <textarea
              id="message"
          ...
          <div>
            <label className="text-[16px] text-gray-700">แนบไฟล์</label>
            <div className="mt-1 flex justify-center rounded-xl border-2 border-dashed border-gray-300 px-6 pt-5 pb-10">
              <div className="space-y-2 text-center">
                <div className="mx-auto h-12 w-12 text-[#ff6a2e]">
                  <Image
                    src="/contactus-page-svg/cloud.svg"
                    alt="cloud"
                    width={100}
                    height={50}
                  />
          ...
          <button
            type="submit"
            className="mt-6 w-full rounded-md bg-[#ff6a2e] px-6 py-3 text-[16px] font-kanit text-white shadow-md transition hover:bg-[#ff5a15]"
          >
            ส่งเอกสาร
          </button>
        </form>
